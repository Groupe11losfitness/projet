...
public class GP_HomeController implements Initializable {
    ...
    void acceuilCliquer(MouseEvent event) throws IOException {
    	 AnchorPane pan  =FXMLLoader.load(getClass().getResource("GP_Acceuil.fxml"));
    ...
    @FXML
    void factursCliquer(MouseEvent event) throws IOException {
    	AnchorPane pan  =FXMLLoader.load(getClass().getResource("GP_list.fxml"));
	  	 panhome.getChildren().clear();
	  	 panhome.getChildren().add(pan);
    }
